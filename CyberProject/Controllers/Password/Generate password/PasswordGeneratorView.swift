        ...
        NavigationView {
            ZStack {
                ...
                Form {
                    ...
                    Section(header: Text("Randomly generated password")) {
            ...
            .popup(isPresented: $passwordViewModel.showAnimation, type: .toast, position: .top, autohideIn: 2) {
                VStack(alignment: .center) {
                    ...
                    Label("Added to vault", systemImage: "checkmark.circle.fill")
                    .padding(14)
            ...
            .popup(isPresented: $clipboardSaveAnimation, type: .toast, position: .top, autohideIn: 2) {
                VStack(alignment: .center) {
                    Spacer()
                        .frame(height: UIScreen.main.bounds.height / 22)
                    Label(settings.ephemeralClipboard ? "Copied (60sec)": "Copied", systemImage: settings.ephemeralClipboard ? "timer" : "checkmark.circle.fill")
                    .padding(14)
                    .foregroundColor(Color.white)
                    .background(Color.blue)
                    .cornerRadius(30)
